...
class CJT_BAO_JournalTagCatchup extends CJT_DAO_JournalTag {
  ...
  static function findAssociated($params, &$batches) {
    // This is safe sql - only alpha and numbers allowed in codes.
    $sql = "select code,catchup_date,description,count from " . CJT_DAO_JournalTagCatchup::getTableName() . " where code = '" . $params['code'] . "' order by catchup_date desc";
