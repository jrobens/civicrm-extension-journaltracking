 ...
 */
class CJT_Page_Journaltracking_View extends CRM_Core_Page {
    ...
    if (!(self::$_links)) {
      self::$_links = array(
        CRM_Core_Action::UPDATE => array(
          'name' => ts('Edit'),
          'url' => 'civicrm/journaltracking/view',
          'qs' => '&id=%%id%%&reset=1',
  ...
  function userContext($mode = null) {
    return 'civicrm/journaltracking/view';
  }
  ...
  function preProcess() {
    ...
    require_once 'CJT/BAO/JournalTagCatchup.php';
    $params['code'] = $defaults['code'];
    CJT_BAO_JournalTagCatchup::retrieve($params, $defaults);
    $catchup_batches = array();
    CJT_BAO_JournalTagCatchup::findAssociated($params, $catchup_batches);
