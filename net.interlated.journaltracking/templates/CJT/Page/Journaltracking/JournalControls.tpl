<h3>Journal Export</h3>

<p>Run a journal export. As part of the export, activities are generated for all
...
<div class="action-link">
    <a href="{crmURL p='civicrm/journaltracking/export' q="reset=1"}" id="newExport" class="button"><span>&raquo; {ts}New Journal Export{/ts}</span></a>
</div>