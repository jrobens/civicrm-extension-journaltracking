...
<div class="crm-block crm-content-block crm-discount-view-form-block">
    ...
    <h3>{ts}View Journal Export{/ts}</h3>
    ...
    <div class="action-link">
        ...
        <div class="crm-submit-buttons">
            ...
            {if call_user_func(array('CRM_Core_Permission','check'), 'administer CiviCRM')}
                <a class="button" href="{crmURL p='civicrm/journaltracking/export-catchup' q=$urlParams}" accesskey="e"><span><div class="icon edit-icon"></div>{ts}Run Update Batch{/ts}</span></a>
                        {/if}
