...
*}
<h3>Export Journal Catchup</h3>

<div class="form-item">
    <fieldset><legend>
            {ts}New Tracked Journal Catchup Export{/ts}
        </legend>
            ...
            <script type="text/javascript">
                cj(document).ready(function() {
                    cj('#_qf_ExportCatchup_cancel-bottom').click(function() {
                        window.location.href = "/civicrm/journaltracking/view?id=" + {/literal}"{$form.catchup_id.value}"{literal} + "&reset=1";
                        return false;
                    });
                });
            </script>
